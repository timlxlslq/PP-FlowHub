...
> **学习快照（2026-09）**：本文用于可视化理解当前源码入口，图中细节会随实现变化；当前规则以 [系统架构](../architecture/system-architecture.md)、[业务规则](../business-rules.md) 和 [发布流程](../release-testing.md) 为准，不把本文当作当前待办或授权。
